...
test('Bug Exploration: No var-proof script in package.json (SHOULD FAIL - proves bug exists)', async () => {
  ...
  console.log(`   Has var-proof script: ${Boolean(hasVarProofScript)}`);
...
test('Bug Exploration: VAR proof script exists but not integrated (SHOULD FAIL - proves bug exists)', async () => {
  ...
  console.log(`   VAR proof script exists: ${Boolean(scriptPath)}`);
  ...
  if (scriptPath) {
    ...
    console.log(`   VAR proof script integrated into package.json: ${Boolean(hasVarProofScript)}`);
    ...
    assert.strictEqual(
      ...
      `Actual: Script exists at ${scriptPath} but not integrated (has script: ${Boolean(hasVarProofScript)}, ` +
