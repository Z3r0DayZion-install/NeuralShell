...
Build under test: `V2.0-RC-Final`  
Release link: `https://github.com/Z3r0DayZion-install/NeuralShell/releases/tag/V2.0-RC-Final`  
...
- Download `NeuralShell.Setup.V2.0-RC-Final.exe` from the release page.
