# NeuralShell Channel Submission Playbook (v1.2.1-OMEGA)
...
- Published Windows installer: `https://github.com/Z3r0DayZion-install/NeuralShell/releases/download/v1.2.1-OMEGA/NeuralShell.Setup.1.2.1-OMEGA.exe`
- Published installer SHA-256: `BE174A1C14B0FF0CDEA85AE865DD020CEAEE359903073FDBD723AF22ED560E61`
- Local Windows build artifact: `dist/NeuralShell Setup 1.2.1-OMEGA.exe`
- App icons:
  - `assets/icon.ico`
  - `assets/icon.png`
  - `assets/icon-512.png`
...
- Microsoft Store screenshot set:
  ...
  - `release/store-assets/microsoft-store/v1.2.1-OMEGA/manifest.json`
...
- Published asset name is `NeuralShell.Setup.1.2.1-OMEGA.exe`.
...
Current status:
- Screenshot set generated in `release/store-assets/microsoft-store/v1.2.1-OMEGA/`
...
- Screenshot set: `release/store-assets/microsoft-store/v1.2.1-OMEGA/`
- Submission packet: `docs/pilots/MICROSOFT_STORE_SUBMISSION_PACKET_v1.2.1-OMEGA.md`
...
- Launch packet: `docs/pilots/PEERLIST_LAUNCH_PACKET_v1.2.1-OMEGA.md`
...
- Submission packet: `docs/pilots/UNEED_SUBMISSION_PACKET_v1.2.1-OMEGA.md`
...
- Submission packet: `docs/pilots/SOURCEFORGE_SUBMISSION_PACKET_v1.2.1-OMEGA.md`
...
- `Capterra` manual packet already exists:
  - `docs/pilots/CAPTERRA_LISTING_SUBMISSION_PACKET_v1.2.1-OMEGA.md`
