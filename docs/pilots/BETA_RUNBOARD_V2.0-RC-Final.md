# NeuralShell Beta Runboard (V2.0-RC-Final)
...
- Triage playbook: `docs/pilots/BETA_TRIAGE_PLAYBOOK_V2.0-RC-Final.md`
- Immutable ledger: `governance/BETA_PILOT_LEDGER_V2.0-RC-Final.jsonl`
- Targeted outreach batch: `docs/pilots/BETA_TARGETED_OUTREACH_EMAIL_BATCH_V2.0-RC-Final.md`
- Reply templates: `docs/pilots/BETA_REPLY_TEMPLATES_V2.0-RC-Final.md`
- Outreach tracker: `docs/pilots/BETA_OUTREACH_TRACKER_V2.0-RC-Final.csv`
...
- Inbound triage runbook: `docs/pilots/BETA_INBOUND_TRIAGE_RUNBOOK_V2.0-RC-Final.md`
- Gmail autopilot setup: `docs/pilots/BETA_GMAIL_AUTOPILOT_SETUP_V2.0-RC-Final.md`
- Capterra listing packet: `docs/pilots/CAPTERRA_LISTING_SUBMISSION_PACKET_V2.0-RC-Final.md`
- Channel submission playbook: `docs/pilots/CHANNEL_SUBMISSION_PLAYBOOK_V2.0-RC-Final.md`
- Channel copy bank: `docs/pilots/CHANNEL_COPY_BANK_V2.0-RC-Final.md`
- WinGet submission packet: `docs/pilots/WINGET_SUBMISSION_PACKET_V2.0-RC-Final.md`
- Microsoft Store submission packet: `docs/pilots/MICROSOFT_STORE_SUBMISSION_PACKET_V2.0-RC-Final.md`
- Microsoft Store screenshot set: `release/store-assets/microsoft-store/V2.0-RC-Final/README.md`
- Press kit: `docs/pilots/PRESS_KIT_V2.0-RC-Final.md`
- Uneed submission packet: `docs/pilots/UNEED_SUBMISSION_PACKET_V2.0-RC-Final.md`
- Peerlist launch packet: `docs/pilots/PEERLIST_LAUNCH_PACKET_V2.0-RC-Final.md`
- SourceForge submission packet: `docs/pilots/SOURCEFORGE_SUBMISSION_PACKET_V2.0-RC-Final.md`
