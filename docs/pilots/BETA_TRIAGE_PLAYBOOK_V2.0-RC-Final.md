# NeuralShell Beta Triage Playbook (V2.0-RC-Final)
...
3. `docs/pilots/BETA_RUNBOARD_V2.0-RC-Final.md` for aggregated tracking.
4. `governance/BETA_PILOT_LEDGER_V2.0-RC-Final.jsonl` for immutable event log.
