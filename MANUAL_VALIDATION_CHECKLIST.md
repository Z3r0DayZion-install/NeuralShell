# NeuralShell v5 Manual Validation Checklist

This document provides a comprehensive manual validation guide for NeuralShell v5. These test cases are designed to be executed in a local development environment to verify the core functional paths and UX hardening.
